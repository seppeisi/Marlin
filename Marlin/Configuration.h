...
#define STRING_CONFIG_H_AUTHOR "Josef Eisgruber" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ANYCUBIC Kossel Linear Plus"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 260.79
    #define DEFAULT_bedKi 45.31
    #define DEFAULT_bedKd 1000.34
  #endif
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 267        // (mm) 267.5???
  ...
  #define DELTA_HEIGHT 275.46             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.565, -1.069 } // Get these values from G33 auto calibrate
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.4 }
